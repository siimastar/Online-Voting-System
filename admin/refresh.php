...
$positions = $conn->query("SELECT * FROM tbPositions") or die("There are no records to display ... \n" . $conn->error);
?>
<?php
session_start();
...
<body id="top">
  ...
  <div>
    ...
    <div>
      ...
      <img src="images/candidate-1.gif" width='<?php if (isset($_POST['Submit'])) {
      ...
      } ?>% of <?php if (isset($_POST['Submit'])) {
                                                                                                                                                        echo $totalvotes;
                                                                                                                                                      } ?> total votes
      <br>votes <?php if (isset($_POST['Submit'])) {
                  echo $candidate_1;
                } ?>
      <br>
      <br>
      ...
      <img src="images/candidate-2.gif" width='<?php if (isset($_POST['Submit'])) {
                                                  if ($candidate_2 || $candidate_1 != 0) {
